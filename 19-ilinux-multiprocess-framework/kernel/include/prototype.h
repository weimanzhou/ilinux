...
// tmp
_PROTOTYPE( int test_int_0, (void) );
...
/*************************************************************************
	> ipc_msg.c
**************************************************************************/
// _PROTOTYPE( int ILINUX_send, (struct process_s *caller, int dest, message_t *msg_phys) );
// _PROTOTYPE( int ILINUX_receive, (struct process_s *caller, int src, message_t *msg_phys) );
